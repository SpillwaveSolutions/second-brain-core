...
3. Cloud Cursor on a knowledge tree: for Q&A spawn a retrieval child (`docs/RETRIEVAL.md`); for a write, pack first, write only via pack scripts, isolate with `brain_session.py`.
